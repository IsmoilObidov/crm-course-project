...
@section('main')
            ...
            <div class="col-12">
                <div id="myModal" class="modal">
                    <div class="modal-content" style="width: 1150px; right:220px;">
                        ...
                        <form class="text-start" action="{{ route('teacher.save_pupil') }}" method="POST"
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    ...
                                    <div class="input-group input-group-outline mb-3">
                                        <img id="blah" src="#" width="250px" height="200px" />
                                ...
                                <div class="col-sm-6" id="zur">
                                    ...
                                    <div class="col-sm-6 input-group input-group-outline" style="padding:5px;">
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle">
                                            <a class="btn btn-info btn-sm modal-button1"
                                                href="{{ route('teacher.edit_pupil', $st->id) }}">
    ...
    <script>
        ...
        function set_data(id) {
            var settings = {
                "url": "{{ env('APP_URL') }}/teacher/pupil_data/" + id,
                "method": "GET",
                "timeout": 0
            };
