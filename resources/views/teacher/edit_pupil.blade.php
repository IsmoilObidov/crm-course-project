...
@section('main')
    ...
    @endif
    <form class="text-start" action="{{ route('teacher.edit_save_pupil', $pupil->id) }}" method="POST"
        ...
        <div class="row">
                ...
                <div class="input-group input-group-outline my-3 ">
                    <div class="col-sm-6 " style="padding:5px;">
                        <div class="input-group input-group-outline mb-3 focus is-focused">
                            ...
                            <input type="text" name="name" class="form-control " value="{{ $pupil->name }}">
                        </div>
                    </div>
                    <div class="col-sm-6" style="padding:5px;">
                        <div class="input-group input-group-outline mb-3 focus is-focused">
                            ...
                            <input type="text" name="email" class="form-control" value="{{ $pupil->email }}">
                        </div>
                    </div>
                </div>
                <div class="input-group input-group-outline mb-3 focus is-focused">
            ...
            <div class="col-sm-6" id="zur">
                ...
                <div class="col-sm-12 input-group input-group-outline">
                    <div class="input-group input-group-outline mb-3 focus is-focused">
                ...
                <div class="col-sm-6 col-sm-6 input-group input-group-outline is-filled" style="padding:5px;">
                ...
                <div class="col-sm-6 input-group input-group-outline mb-4 " style="padding:5px;">
        ...
        <div class="text-center">
            <button type="submit" class="btn bg-gradient-primary w-100 my-2 mb-2"
