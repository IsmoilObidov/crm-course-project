                        ...
                        <form role="form" class="text-start" action="{{ route('admin.create_user') }}" method="POST"
                            ...
                            <div class="input-group input-group-outline mb-3">
                                <a id="img_url" style="cursor: zoom-in" target="_blank"><img id="blah" src="#"
                                        width="200px" height="100px" style="display: none;" onclick="$(this).show()" /></a>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <p class="text-xs font-weight-bold mb-0"
                                                    ...
                                                    {{ $st->role->name }}</p>
                                                <p class="text-xs text-secondary mb-0">{{ Auth::user()->get_course->name }}
                                                </p>
                                            </td>
                                            ...
                                            <td class="align-middle text-center">
                                                <a class="btn btn-info btn-sm"
                                                    href="{{ route('registrator.view_groups', $st->id) }}">
                                                    <svg xmlns="http://www.w3.org/2000/svg" height="16" width="20"
                                                        viewBox="0 0 640 512">
                                                        <path fill="#ffffff"
                                            ...
                                            <td class="align-middle text-center">
                                                <a class="btn btn-danger btn-sm"
                                                    href="{{ route('registrator.edit_staff', $st->id) }}">Изменить</a>
                                            </td>
