                        ...
                        <form role="form" class="text-start" action="{{ route('create_admin') }}" method="POST"
                            ...
                            <div style="float: left;width:50%; ">
                                ...
                                <div class="input-group input-group-outline mb-3">
                                    ...
                                    <input type="text" name="adress" class="form-control" style="height: 45px;">
                                </div>
                                <div class="input-group input-group-outline my-3">
                            ...
                            <div style="float: right;width:50%; padding-left:25px;margin-top:10px;">
                                <div class="input-group input-group-outline mb-3">
                                    ...
                                    <input type="text" name="instagram" class="form-control" style="height: 45px;">
                                </div>
                                <div class="input-group input-group-outline mb-3">
                                    <label class="form-label">Телеграм</label>
                                    <input type="text" name="telegram" class="form-control" style="height: 45px;">
                                </div>
                                <div class="input-group input-group-outline mb-3">
                                    <label class="form-label">последний оплата</label>
                                    <input type="date" name="finish_billing" class="form-control" style="height: 45px;">
                                </div>
